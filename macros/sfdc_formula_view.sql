...
{{ exceptions.warn("\ERROR: Parameters full_statement_version=false, reserved_table_name, and fields_to_include are no longer supported. Update your " ~ this.identifier|upper ~ " model to remove these parameters.\n") }}
* Refer to error in log.
{% endif %}
