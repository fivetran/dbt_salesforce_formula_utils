...
## Feature Update
- Adds [Managed Data Lake Service](https://fivetran.com/docs/managed-data-lake-service) compatibility for **BigQuery**, **Snowflake**, **Redshift**, and **Databricks** query engines.
